...
var printUnpackOpCase = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 311, column 21 - line 319, column 30): " + [ v.constructor.name ]);
};
...
var printDistOpCase = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 322, column 19 - line 334, column 32): " + [ v.constructor.name ]);
};
...
var printBackendRewriteCase = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 296, column 27 - line 308, column 27): " + [ v.constructor.name ]);
};
var printBackendAccessor = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 408, column 24 - line 414, column 28): " + [ v.constructor.name ]);
};
...
var printLiteral = /* #__PURE__ */ (function () {
    ...
    return function ($245) {
        return $244((function (v) {
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 417, column 35 - line 431, column 53): " + [ v.constructor.name ]);
        })($245));
    };
})();
var primOp = function (ns) {
    return function (op) {
        ...
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 384, column 1 - line 384, column 38): " + [ ns.constructor.name, op.constructor.name ]);
    };
};
var printBackendEffect = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 340, column 22 - line 346, column 59): " + [ v.constructor.name ]);
};
var printBackendOperator1 = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 356, column 25 - line 362, column 96): " + [ v.constructor.name ]);
};
var printBackendOperatorNum = function (ns) {
    ...
    return function ($247) {
        return $246((function (v) {
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 392, column 44 - line 396, column 22): " + [ v.constructor.name ]);
        })($247));
    };
};
var printBackendOperatorOrd = function (ns) {
    ...
    return function ($249) {
        return $248((function (v) {
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 399, column 44 - line 405, column 17): " + [ v.constructor.name ]);
        })($249));
    };
};
var printBackendOperator2 = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 365, column 25 - line 382, column 58): " + [ v.constructor.name ]);
};
var printBackendOperator = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 349, column 24 - line 353, column 65): " + [ v.constructor.name ]);
};
var printBackendSyntax = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 214, column 22 - line 293, column 6): " + [ v.constructor.name ]);
};
