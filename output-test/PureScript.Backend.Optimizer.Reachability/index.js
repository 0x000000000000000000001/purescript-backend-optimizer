...
var moduleReachability = function (entryMods) {
    return function (modulesMap) {
        var getModuleDeps = function (modName) {
                    ...
                    return function (v1) {
                        return foldl1(function (acc2) {
                            return function (v2) {
                                ...
                                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Reachability (line 55, column 27 - line 57, column 44): " + [ v2.value0.constructor.name ]);
                            };
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Reachability (line 47, column 7 - line 65, column 20): " + [ v.constructor.name ]);
        };
