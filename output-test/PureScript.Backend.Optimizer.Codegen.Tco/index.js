...
var syntacticArity = function (v) {
    if (v instanceof PureScript_Backend_Optimizer_Syntax.Abs) {
        ...
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Codegen.Tco (line 248, column 5 - line 250, column 50): " + [ v1.constructor.name ]);
    };
    if (v instanceof PureScript_Backend_Optimizer_Syntax.UncurriedAbs) {
        ...
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Codegen.Tco (line 252, column 5 - line 254, column 42): " + [ v1.constructor.name ]);
    };
    if (v instanceof PureScript_Backend_Optimizer_Syntax.Typed) {
