            ...
            return function (expr) {
                ...
                var v1 = function (v2) {
                    if (v instanceof PureScript_Backend_Optimizer_Semantics.ExprSyntax && v.value1 instanceof PureScript_Backend_Optimizer_Syntax.CtorDef) {
                        ...
                        var meta = fromJust(lookup(v.value1.value1)(env.dataTypes));
                    ...
                    var t = (function () {
                        if (isDict) {
                            return trace("toExternImpl fallback for Dict!")(function (v4) {
                ...
                if (isDict) {
                    var $484 = getLitRecord(v);
                    if ($484 instanceof Data_Maybe.Just) {
                        var propsWithAnalysis = map(map1(PureScript_Backend_Optimizer_Semantics.freeze))($484.value0);
...
var toCaseRowVars = function (v) {
    return foldMap((function () {
        var $928 = Data_Function.flip(Data_Map_Internal.singleton)(v.column);
        return function ($929) {
            return Data_Map.SemigroupMap($928($929));
        };
    })())(v.pattern.vars);
};
...
var isTypeClassDictionaryWithProps = function (expr) {
    ...
    if (expr instanceof PureScript_Backend_Optimizer_CoreFn.ExprApp && (expr.value2 instanceof PureScript_Backend_Optimizer_CoreFn.ExprLit && expr.value2.value1 instanceof PureScript_Backend_Optimizer_CoreFn.LitRecord)) {
        var $536 = getConstructorMeta(expr.value1);
        if ($536 instanceof Data_Maybe.Just) {
            var $537 = eq8($536.value0)(PureScript_Backend_Optimizer_CoreFn.IsTypeClassConstructor.value) || eq8($536.value0)(PureScript_Backend_Optimizer_CoreFn.IsNewtype.value);
            if ($537) {
        ...
        return function (backendExpr) {
            return function (cfn) {
                var fromImpl = (function () {
                    if (impl instanceof PureScript_Backend_Optimizer_Semantics.ExternExpr && (impl.value1 instanceof PureScript_Backend_Optimizer_Syntax.App && impl.value1.value0 instanceof PureScript_Backend_Optimizer_Syntax.Var)) {
                        ...
                        if (v instanceof Data_Maybe.Just) {
                            ...
                            var $551 = Data_Map_Internal.isEmpty(newDirs);
                            if ($551) {
                                return Data_Maybe.Nothing.value;
                            };
                ...
                var fromBackendExpr = (function () {
                    ...
                    var v = function (v1) {
                        if (backendExpr instanceof PureScript_Backend_Optimizer_Semantics.ExprSyntax && (backendExpr.value1 instanceof PureScript_Backend_Optimizer_Syntax.App && (backendExpr.value1.value0 instanceof PureScript_Backend_Optimizer_Semantics.ExprSyntax && backendExpr.value1.value0.value1 instanceof PureScript_Backend_Optimizer_Syntax.Var))) {
                            ...
                            if (v2 instanceof Data_Maybe.Just && v2.value0 instanceof PureScript_Backend_Optimizer_Semantics.InlineArity) {
                                var $582 = Data_Array_NonEmpty.length(backendExpr.value1.value1);
                                var $583 = $582 >= v2.value0.value0;
                                if ($583) {
                                    return new Data_Maybe.Just(Data_Map_Internal.singleton(PureScript_Backend_Optimizer_Semantics.InlineRef.value)(PureScript_Backend_Optimizer_Semantics.InlineAlways.value));
                                };
                                return v3(true);
                    ...
                    var $594 = isTypeClassDictionaryWithProps(cfn);
                    if ($594.value0) {
                        return new Data_Maybe.Just(fromFoldable2(append([ new Data_Tuple.Tuple(PureScript_Backend_Optimizer_Semantics.InlineRef.value, PureScript_Backend_Optimizer_Semantics.InlineAlways.value) ])(map(function (p) {
...
var inferExprType = function (v) {
    if (v instanceof PureScript_Backend_Optimizer_CoreFn.ExprApp) {
        ...
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 1098, column 8 - line 1100, column 28): " + [ v2.constructor.name ]);
    };
    return Data_Maybe.Nothing.value;
};
        ...
        return function (acc) {
            return bind(lookup1(qual)(env.implementations))(function (v) {
                ...
                if (v.value1 instanceof PureScript_Backend_Optimizer_Semantics.ExternDict) {
                    ...
                    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 475, column 9 - line 479, column 19): " + [ acc.constructor.name ]);
                };
                if (v.value1 instanceof PureScript_Backend_Optimizer_Semantics.ExternCtor) {
                    return Data_Maybe.Nothing.value;
                };
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 469, column 5 - line 481, column 16): " + [ v.value1.constructor.name ]);
            });
        };
    };
    return {
        ...
        analyze: function (v) {
            return function (expr) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 457, column 7 - line 463, column 38): " + [ v1.constructor.name ]);
            };
        },
        effect: false
    };
...
var fromExternImpl = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 484, column 18 - line 487, column 34): " + [ v.constructor.name ]);
};
var decompose = function (chosenColumn) {
    ...
    var checkMatch = function (p) {
        ...
        var $653 = eq9(p.column)(chosenColumn.column);
        if ($653) {
            var $654 = eq11(patternPatCase(p))(PatWild.value) || Data_Function.on(eq11)(patternPatCase)(chosenColumn)(p);
            if ($654) {
                return {
                    nonMatchesBefore: [  ],
                    match: new Data_Maybe.Just({
    ...
    return foldMap3(function (row) {
        ...
        if (v instanceof Data_Maybe.Just) {
            var v1 = PureScript_Backend_Optimizer_Utils.foldl1Array(function (l) {
                var $930 = mergeResults(l);
                return function ($931) {
                    return $930(checkMatch($931));
                };
            })(checkMatch)(v.value0);
            if (v1.match instanceof Data_Maybe.Just) {
                return {
                    ...
                    rowsNoMatch: (function () {
                        var $658 = eq11(patternPatCase(v1.match.value0.match))(PatWild.value);
                        if ($658) {
                            return [ row ];
                        };
                        return [  ];
    ...
    return function (tailRows) {
        ...
        if (expandIfPossible instanceof Data_Maybe.Nothing) {
                        ...
                        if (v1 instanceof Data_Maybe.Just) {
                            return {
                                ...
                                aScore: -Data_Array.length(Data_Array.filter((function () {
                                    var $932 = notEq1(PatWild.value);
                                    return function ($933) {
                                        return $932(patternPatCase($933));
                                    };
            ...
            var heuristic = composeKleisli(maximumByAll1(comparing1(function (v) {
                ...
                var $934 = map2(function ($937) {
                    return (function (v) {
                        return v.pattern;
                    })(Data_Array_NonEmpty.head($937));
                });
                var $935 = maximumByAll1(comparing1(function (v) {
                    return v.aScore;
                }));
                return function ($936) {
                    return $934($935($936));
...
var $lazy_binderToPattern = /* #__PURE__ */ $runtime_lazy("binderToPattern", "PureScript.Backend.Optimizer.Convert", function () {
    ...
    return function (v) {
        ...
        if (v instanceof PureScript_Backend_Optimizer_CoreFn.BinderNamed) {
            ...
            }))($lazy_binderToPattern(668)(v.value2));
        };
        if (v instanceof PureScript_Backend_Optimizer_CoreFn.BinderLit) {
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 669, column 22 - line 689, column 18): " + [ v.value1.constructor.name ]);
        };
        if (v instanceof PureScript_Backend_Optimizer_CoreFn.BinderConstructor) {
            ...
            if (v.value0.meta instanceof Data_Maybe.Just && v.value0.meta.value0 instanceof PureScript_Backend_Optimizer_CoreFn.IsNewtype) {
                if (v.value3.length === 1) {
                    return $lazy_binderToPattern(695)(v["value3"][0]);
                };
                return v1(true);
            };
            return v1(true);
        };
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 663, column 19 - line 713, column 55): " + [ v.constructor.name ]);
    };
});
var binderToPattern = /* #__PURE__ */ $lazy_binderToPattern(662);
    ...
    var go = (function () {
                                ...
                                return bind1(zipWithA(function (ident) {
                                    ...
                                    if (v.value1 instanceof PureScript_Backend_Optimizer_CoreFn.Guarded) {
                                        return foldr(function (v1) {
                                            ...
                                            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 599, column 23 - line 602, column 86): " + [ v1.constructor.name ]);
                                        })(v.value1.value0)([  ]);
                                    };
                                    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 588, column 13 - line 605, column 19): " + [ v.value1.constructor.name ]);
                                });
                            };
                        };
                    })(useCaseRowsCb)(alts)([  ]);
        ...
        return function (v) {
                ...
                return bind1(ask)(function (v1) {
                    var v2 = function (v3) {
                        ...
                        if (v.value1.value0 instanceof Data_Maybe.Just) {
                            var $742 = eq10(v.value1.value0.value0)(v1.currentModule);
                            if ($742) {
                                var $743 = lookup4(v.value1.value1)(v1.toLevel);
                                if ($743 instanceof Data_Maybe.Just) {
                                    return buildM(new PureScript_Backend_Optimizer_Syntax.Local(new Data_Maybe.Just(v.value1.value1), $743.value0));
                                };
                                return v4(true);
                            };
                            return v4(true);
                    ...
                    if (v.value1.value0 instanceof Data_Maybe.Nothing) {
                        var $749 = lookup4(v.value1.value1)(v1.toLevel);
                        if ($749 instanceof Data_Maybe.Just) {
                            return buildM(new PureScript_Backend_Optimizer_Syntax.Local(new Data_Maybe.Just(v.value1.value1), $749.value0));
                        };
                        return v2(true);
                    };
                    return v2(true);
            ...
            if (v instanceof PureScript_Backend_Optimizer_CoreFn.ExprLit) {
                return bindFlipped(function ($938) {
                    return buildM(PureScript_Backend_Optimizer_Syntax.Lit.create($938));
            ...
            if (v instanceof PureScript_Backend_Optimizer_CoreFn.ExprAccessor) {
                return bindFlipped((function () {
                    var $939 = Data_Function.flip(PureScript_Backend_Optimizer_Syntax.Accessor.create)(new PureScript_Backend_Optimizer_Syntax.GetProp(v.value2));
                    return function ($940) {
                        return buildM($939($940));
                    };
            ...
            var v1 = function (v2) {
                    ...
                    var go1 = function (bind$prime) {
                        return function (next) {
                            ...
                            var v3 = function (v4) {
                                ...
                                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 503, column 1 - line 503, column 50): " + [ bind$prime.constructor.name ]);
                            };
                            if (bind$prime instanceof PureScript_Backend_Optimizer_CoreFn.Rec) {
                                var $789 = Data_Array_NonEmpty.fromArray(bind$prime.value0);
                                if ($789 instanceof Data_Maybe.Just) {
                                    return bind1(currentLevel)(function (lvl) {
                                        ...
                                        })(intro2(idents)(lvl)(traverse3(toBackendBinding)($789.value0))))(intro2(idents)(lvl)(next)));
                                    });
                                };
                                return v3(true);
                            };
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 503, column 1 - line 503, column 50): " + [ v.constructor.name ]);
            };
            if (v instanceof PureScript_Backend_Optimizer_CoreFn.ExprApp) {
    ...
    return bind1(go(expr))(function (backendExpr) {
        return pure1((function () {
            var v1 = (function () {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 508, column 13 - line 510, column 45): " + [ v.type.constructor.name ]);
            })();
            if (v1 instanceof Data_Maybe.Just) {
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 508, column 8 - line 512, column 27): " + [ v1.constructor.name ]);
        })());
    });
};
...
var buildCaseTreeFromRows = function (denormalizedRows) {
    ...
    if (v instanceof Data_Maybe.Just) {
        ...
        var row0NonPatWildPatterns = Data_Array_NonEmpty.fromArray(foldlWithIndex(function (idx) {
            return function (acc) {
                return function (p) {
                    var $822 = notEq1(patternPatCase(p))(PatWild.value);
                    if ($822) {
    ...
    return function (env) {
        return function (v) {
            ...
            var optimizedExprWithTy = (function () {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 285, column 27 - line 287, column 31): " + [ mbType.constructor.name ]);
            })();
            ...
            return {
                accum: {
                    ...
                    optimizationSteps: Data_Maybe.maybe(env.optimizationSteps)((function () {
                        var $941 = Data_Array.snoc(env.optimizationSteps);
                        var $942 = Data_Tuple.Tuple.create(qualifiedIdent);
                        return function ($943) {
                            return $941($942($943));
                        };
                    ...
                    directives: (function () {
                        ...
                        if (v4 instanceof Data_Maybe.Just) {
                            return alter(function (v5) {
                                ...
                                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 298, column 17 - line 302, column 30): " + [ v5.constructor.name ]);
                        ...
                        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 295, column 11 - line 306, column 29): " + [ v4.constructor.name ]);
                    })()
                },
...
var toBackendTopLevelBindingGroup = function (env) {
    ...
    return function (v) {
        ...
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 253, column 37 - line 260, column 52): " + [ v.constructor.name ]);
    };
};
var toBackendTopLevelBindingGroups = function (binds) {
    return function (env) {
        ...
        return {
            ...
            })(Data_Array.groupBy(Data_Function.on(conj)(function ($944) {
                return !(function (v1) {
                    return v1.recursive;
                })($944);
            }))(result.value))
    ...
    return function (env) {
        ...
        var isBindingUsed = function (deps) {
            return function (v1) {
                ...
                var $904 = unwrap(v.name) === "Data.Set";
                if ($904) {
                    return res;
                };
                return res;
        ...
        var dataTypes = fromFoldable4(map(function (group) {
            ...
            var sizes = map4(function ($945) {
                return Data_Array.length(Data_Tuple.snd(Data_Tuple.snd($945)));
            })(group);
        ...
        var usedBindings = mapAccumR(function (deps) {
            return function (group) {
                var v1 = (function () {
                    if (group.recursive) {
                        var $913 = Data_Array.any(isBindingUsed(deps))(group.bindings);
                        if ($913) {
                            return {
                                accum: append4(foldMap5(function ($946) {
                                    return Data_Tuple.fst(Data_Tuple.snd($946));
                                })(group.bindings))(deps),
                                value: map((function () {
                                    var $947 = map5(Data_Tuple.snd);
                                    return function ($948) {
                                        return Data_Maybe.Just.create($947($948));
                                    };
                                })())(group.bindings)
                            };
                        };
                    ...
                    return mapAccumR(function (deps$prime) {
                        return function (v2) {
                            var $915 = isBindingUsed(deps$prime)(v2);
                            if ($915) {
                                return {
        ...
        return new Data_Tuple.Tuple(moduleBindings.accum.optimizationSteps, {
            ...
            dataTypes: filter((function () {
                var $949 = Data_Array.any(isBindingUsed(usedBindings.accum));
                return function ($950) {
                    return $949(toUnfoldable1((function (v1) {
