...
var printActionGeneric = {
    to: function (x) {
        ...
        throw new Error("Failed pattern match at Test.Spec.Reporter.Spec (line 57, column 1 - line 57, column 60): " + [ x.constructor.name ]);
    },
    from: function (x) {
...
var print = function (dictMonadState) {
    ...
    return function (dictMonadWriter) {
        ...
        return function (path) {
            var indent = function ($106) {
                return Test_Spec_Style.indent(Data_Array.length($106));
            };
            return function (v) {
                ...
                if (v instanceof PrintTest && v.value1 instanceof Test_Spec_Result.Failure) {
                    return bind1(modify(function (s) {
                        ...
                        $79.numFailures = s.numFailures + 1 | 0;
                        return $79;
                    }))(function (v1) {
                ...
                throw new Error("Failed pattern match at Test.Spec.Reporter.Spec (line 67, column 14 - line 80, column 65): " + [ v.constructor.name ]);
            };
        };
    };
};
...
var specReporter = /* #__PURE__ */ Test_Spec_Reporter_Base.defaultReporter(initialState)(/* #__PURE__ */ Test_Spec_Reporter_Base.defaultUpdate({
    ...
    printFinishedItem: function (v) {
        return function (v1) {
            ...
            if (v1 instanceof Test_Spec_Reporter_Base.RunningSuite && v1.value0) {
                return print1(v.value0)(new PrintSuite(v.value1));
            };
    ...
    update: function (v) {
        if (v instanceof Test_Spec_Runner_Event.Suite && v.value0 instanceof Test_Spec_Runner_Event.Sequential) {
            return print1(v.value1.value0)(new PrintSuite(v.value1.value1));
        };
