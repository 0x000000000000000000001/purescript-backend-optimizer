...
var qualLength = /* #__PURE__ */ Data_Maybe.maybe(0)(/* #__PURE__ */ (function () {
    ...
    return function ($321) {
        return $319(Data_String_CodePoints.length($320($321)));
    };
})());
    ...
    return function (regexStr) {
        ...
        return function (str) {
            ...
            if (v instanceof Data_Maybe.Just) {
                var $151 = Data_Array_NonEmpty.head(v.value0);
                if ($151 instanceof Data_Maybe.Just) {
                    return new LexSucc($151.value0, Data_String_CodeUnits.drop(Data_String_CodeUnits.length($151.value0))(str));
                };
                return v1(true);
            };
            return v1(true);
...
var string = function (mkErr) {
    return function (match) {
        return function (str) {
            var $156 = Data_String_CodeUnits.take(Data_String_CodeUnits.length(match))(str) === match;
            if ($156) {
...
var fail = function ($322) {
    return Lex(LexFail.create(Data_Function["const"]($322)));
};
var char$prime = function (mkErr) {
    return function (res) {
        return function (match) {
            return function (str) {
                var $172 = Data_String_CodeUnits.singleton(match) === Data_String_CodeUnits.take(1)(str);
                if ($172) {
...
var lineComment = /* #__PURE__ */ (function () {
    return alt(map((function () {
        var $324 = PureScript_CST_Types.Line.create(PureScript_CST_Types.LF.value);
        return function ($325) {
            return $324(Data_String_CodePoints.length($325));
        };
    })())(regex(PureScript_CST_Errors.LexExpected.create("newline"))("\x0a+")))(map((function () {
        var $326 = PureScript_CST_Types.Line.create(PureScript_CST_Types.CRLF.value);
        return function ($327) {
            return $326((function (v) {
                return div(v)(2);
            })(Data_String_CodePoints.length($327)));
        };
    ...
    var parseNumber = bind1(intPartRegex)(function (intPart) {
        return bind1(parseNumberFractionPart)(function (fractionPart) {
            return bind1(parseNumberExponentPart)(function (exponentPart) {
                var $282 = Data_Maybe.isNothing(fractionPart) && Data_Maybe.isNothing(exponentPart);
                if ($282) {
