...
var getFieldOptional$prime = function (decode) {
    return function (obj) {
        return function (prop) {
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.CoreFn.Json (line 505, column 3 - line 512, column 31): " + [ v.constructor.name ]);
        };
    };
};
var getField = function (decode) {
    return function (obj) {
        return function (prop) {
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.CoreFn.Json (line 497, column 3 - line 501, column 18): " + [ v.constructor.name ]);
        };
    };
};
...
var decodeArray = function (decoder) {
    return function (json) {
                ...
                (function () {
                    while (con) {
                        (function __do() {
                            ...
                            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.CoreFn.Json (line 484, column 9 - line 492, column 22): " + [ v1.constructor.name ]);
                        })();
                    };
                    return {};
                })();
        ...
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.CoreFn.Json (line 467, column 28 - line 493, column 19): " + [ v.constructor.name ]);
    };
};
...
var bind = function (a) {
    return function (k) {
        ...
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.CoreFn.Json (line 52, column 12 - line 56, column 9): " + [ a.constructor.name ]);
    };
};
...
var decodeInt = function (json) {
    return bind(decodeNumber(json))(function (num) {
        ...
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.CoreFn.Json (line 557, column 3 - line 565, column 16): " + [ v.constructor.name ]);
    });
};
...
var alt = function (a) {
    return function (k) {
        ...
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.CoreFn.Json (line 45, column 11 - line 47, column 15): " + [ a.constructor.name ]);
    };
};
                ...
                if (v2 instanceof Data_Maybe.Nothing) {
                    ...
                    if (v3 instanceof Data_Maybe.Nothing) {
                        ...
                        if (v4 instanceof Data_Maybe.Nothing) {
                            ...
                            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.CoreFn.Json (line 156, column 24 - line 199, column 60): " + [ v5.constructor.name ]);
                        };
                        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.CoreFn.Json (line 150, column 22 - line 199, column 60): " + [ v4.constructor.name ]);
                    };
                    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.CoreFn.Json (line 146, column 20 - line 199, column 60): " + [ v3.constructor.name ]);
                };
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.CoreFn.Json (line 140, column 18 - line 199, column 60): " + [ v2.constructor.name ]);
            };
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.CoreFn.Json (line 134, column 5 - line 199, column 60): " + [ v1.constructor.name ]);
        });
    };
                                                ...
                                                return bind(getField(decodeArray(decodeIdent))(obj)("foreign"))(function (foreign_arr) {
                                                    return bind(map(Data_Maybe.fromMaybe(Foreign_Object.empty))(getFieldOptional$prime(decodeJObject)(obj)("foreignAnnotations")))(function (foreign_anns) {
                                                        return bind(traverse(function (v) {
                                                            ...
                                                            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.CoreFn.Json (line 287, column 5 - line 292, column 35): " + [ v1.constructor.name ]);
