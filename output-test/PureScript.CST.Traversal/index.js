            ...
            onBinder: function (a) {
                return function (ctx) {
                    return bind2(visitor.onBinder(ctx)(a))(Data_Tuple.uncurry(Data_Function.flip((function () {
                        var $680 = traverseBinder3(visitor$prime);
                        return function ($681) {
            ...
            onExpr: function (a) {
                return function (ctx) {
                    return bind2(visitor.onExpr(ctx)(a))(Data_Tuple.uncurry(Data_Function.flip((function () {
                        var $682 = traverseExpr3(visitor$prime);
                        return function ($683) {
            ...
            onDecl: function (a) {
                return function (ctx) {
                    return bind2(visitor.onDecl(ctx)(a))(Data_Tuple.uncurry(Data_Function.flip((function () {
                        var $684 = traverseDecl3(visitor$prime);
                        return function ($685) {
            ...
            onType: function (a) {
                return function (ctx) {
                    return bind2(visitor.onType(ctx)(a))(Data_Tuple.uncurry(Data_Function.flip((function () {
                        var $686 = traverseType3(visitor$prime);
                        return function ($687) {
                            return Control_Monad_Reader_Trans.runReaderT($686($687));
                        };
                    })())));
                };
            }
        ...
        onBinder: function (a) {
            return function (ctx) {
                return bind(pure(visitor.onBinder(ctx)(a)))(Data_Tuple.uncurry(Data_Function.flip((function () {
                    var $688 = traverseBinder1(visitor$prime);
                    return function ($689) {
                        return Control_Monad_Reader_Trans.runReaderT($688($689));
                    };
                })())));
            };
        },
        onExpr: function (a) {
            return function (ctx) {
                return bind(pure(visitor.onExpr(ctx)(a)))(Data_Tuple.uncurry(Data_Function.flip((function () {
                    var $690 = traverseExpr1(visitor$prime);
                    return function ($691) {
                        return Control_Monad_Reader_Trans.runReaderT($690($691));
                    };
                })())));
            };
        },
        onDecl: function (a) {
            return function (ctx) {
                return bind(pure(visitor.onDecl(ctx)(a)))(Data_Tuple.uncurry(Data_Function.flip((function () {
                    var $692 = traverseDecl1(visitor$prime);
                    return function ($693) {
                        return Control_Monad_Reader_Trans.runReaderT($692($693));
                    };
                })())));
            };
        },
        onType: function (a) {
            return function (ctx) {
                return bind(pure(visitor.onType(ctx)(a)))(Data_Tuple.uncurry(Data_Function.flip((function () {
                    var $694 = traverseType1(visitor$prime);
                    return function ($695) {
                        return Control_Monad_Reader_Trans.runReaderT($694($695));
                    };
                })())));
            };
        }
...
var rewriteTopDown = function (traversal) {
    return function (visitor) {
        ...
        var $696 = runFree(un(Data_Identity.Identity));
        var $697 = traversal(visitor$prime);
        return function ($698) {
            return $696($697($698));
        };
    };
...
var bottomUpPureTraversal = function (visitor) {
    var visitor$prime = {
        onBinder: function (a) {
            return bindFlipped(function ($699) {
                return pure1(visitor.onBinder($699));
            })(traverseBinder2(visitor$prime)(a));
        },
        onExpr: function (a) {
            return bindFlipped(function ($700) {
                return pure1(visitor.onExpr($700));
            })(traverseExpr2(visitor$prime)(a));
        },
        onType: function (a) {
            return bindFlipped(function ($701) {
                return pure1(visitor.onType($701));
            })(traverseType2(visitor$prime)(a));
        },
        onDecl: function (a) {
            return bindFlipped(function ($702) {
                return pure1(visitor.onDecl($702));
...
var rewriteBottomUp = function (traversal) {
    return function (visitor) {
        ...
        var $703 = runFree(un(Data_Identity.Identity));
        var $704 = traversal(visitor$prime);
        return function ($705) {
            return $703($704($705));
        };
    };
