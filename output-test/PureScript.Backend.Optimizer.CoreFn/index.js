    ...
    traverse: function (dictApplicative) {
        ...
        return function (k) {
            return function (v) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.CoreFn (line 243, column 16 - line 250, column 40): " + [ v.constructor.name ]);
            };
        };
    },
    sequence: function (dictApplicative) {
...
var exprAnn = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.CoreFn (line 274, column 11 - line 283, column 21): " + [ v.constructor.name ]);
};
