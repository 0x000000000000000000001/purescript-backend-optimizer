...
var eq = /* #__PURE__ */ Data_Eq.eq(/* #__PURE__ */ Data_Eq.eqArray(Test_Spec_Tree.eqPathItem));
...
var printSummary = function (dictMonadWriter) {
    ...
    var printPending = function (p) {
        ...
        throw new Error("Failed pattern match at Test.Spec.Reporter.Console (line 64, column 5 - line 64, column 34): " + [ p.constructor.name ]);
    };
    return function ($118) {
        return (function (v) {
        ...
        })(Test_Spec_Summary.summarize($118));
    };
};
...
var printActionGeneric = {
    to: function (x) {
        ...
        throw new Error("Failed pattern match at Test.Spec.Reporter.Console (line 77, column 1 - line 77, column 60): " + [ x.constructor.name ]);
    },
    from: function (x) {
                    ...
                    return discard1((function () {
                        ...
                        return discard1(tellLn(Test_Spec_Style.styled(append1(Test_Spec_Style.bold)(Test_Spec_Style.magenta))(intercalate(" \xbb ")(Test_Spec_Tree.parentSuiteName(path)))))(function () {
                            return put((function () {
                                ...
                                $93.lastPrintedSuitePath = new Data_Maybe.Just(path);
                                return $93;
                            })());
                        });
                    })())(function () {
                        ...
                        throw new Error("Failed pattern match at Test.Spec.Reporter.Console (line 95, column 3 - line 103, column 56): " + [ a.constructor.name ]);
                    });
                });
            };
        };
...
var consoleReporter = /* #__PURE__ */ Test_Spec_Reporter_Base.defaultReporter(initialState)(/* #__PURE__ */ Test_Spec_Reporter_Base.defaultUpdate({
    ...
    printFinishedItem: function (v) {
        return function (v1) {
            if (v1 instanceof Test_Spec_Reporter_Base.RunningTest && v1.value0 instanceof Data_Maybe.Just) {
                return print1(v.value0)(new PrintTest(v.value1, v1.value0.value0));
            };
            if (v1 instanceof Test_Spec_Reporter_Base.RunningPending) {
                return print1(v.value0)(new PrintPending(v.value1));
            };
    ...
    update: function (v) {
        if (v instanceof Test_Spec_Runner_Event.Pending) {
            return bind(get)(function (v1) {
                return when(Data_Map_Internal.isEmpty(v1.runningItems))(print1(v.value0.value0)(new PrintPending(v.value0.value1)));
            });
        };
