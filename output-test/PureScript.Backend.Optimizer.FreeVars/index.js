...
var paramTypes = function (v) {
    ...
    if (v.value1 instanceof PureScript_Backend_Optimizer_Syntax.PrimOp) {
        ...
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.FreeVars (line 122, column 16 - line 124, column 61): " + [ v.value1.value0.constructor.name ]);
    };
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.FreeVars (line 96, column 31 - line 127, column 22): " + [ v.value1.constructor.name ]);
};
var localId = function (v) {
    return function (v1) {
        ...
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.FreeVars (line 30, column 1 - line 30, column 42): " + [ v.constructor.name, v1.constructor.name ]);
    };
};
var freeVars = function (v) {
    ...
    if (v.value1 instanceof PureScript_Backend_Optimizer_Syntax.PrimOp) {
        ...
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.FreeVars (line 87, column 16 - line 89, column 57): " + [ v.value1.value0.constructor.name ]);
    };
    if (v.value1 instanceof PureScript_Backend_Optimizer_Syntax.PrimEffect) {
        return Data_Set.empty;
    };
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.FreeVars (line 36, column 31 - line 93, column 26): " + [ v.value1.constructor.name ]);
};
export {
    sanitizeName,
    localId,
