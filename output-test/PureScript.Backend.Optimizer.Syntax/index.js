    ...
    foldMap: function (dictMonoid) {
        ...
        return function (f) {
            return function (v) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Syntax (line 247, column 15 - line 249, column 28): " + [ v.constructor.name ]);
            };
        };
    }
};
    ...
    traverse: function (dictApplicative) {
        ...
        return function (f) {
            return function (v) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Syntax (line 253, column 16 - line 255, column 39): " + [ v.constructor.name ]);
            };
        };
    },
    Functor0: function () {
    ...
    foldMap: function (dictMonoid) {
        ...
        return function (f) {
            return function (v) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Syntax (line 262, column 15 - line 265, column 37): " + [ v.constructor.name ]);
            };
        };
    }
};
    ...
    foldMap: function (dictMonoid) {
        ...
        return function (f) {
            return function (v) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Syntax (line 140, column 15 - line 169, column 21): " + [ v.constructor.name ]);
            };
        };
    }
};
    ...
    traverse: function (dictApplicative) {
        ...
        return function (f) {
            return function (v) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Syntax (line 269, column 16 - line 272, column 57): " + [ v.constructor.name ]);
            };
        };
    },
    Functor0: function () {
        ...
        return function (f) {
            return function (v) {
                ...
                if (v instanceof Lit) {
                    ...
                    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Syntax (line 179, column 7 - line 186, column 71): " + [ v.value0.constructor.name ]);
                };
                if (v instanceof App) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Syntax (line 173, column 16 - line 229, column 22): " + [ v.constructor.name ]);
            };
        };
    },
    Functor0: function () {
