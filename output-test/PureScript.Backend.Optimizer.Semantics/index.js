...
var hasAnalysisBackendExpr = {
    analysisOf: function (v) {
        ...
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 159, column 16 - line 161, column 25): " + [ v.constructor.name ]);
    }
};
            ...
            return function (body) {
                ...
                if (binding instanceof ExprSyntax && binding.value1 instanceof PureScript_Backend_Optimizer_Syntax.Update) {
                    ...
                    if ($789 instanceof Data_Maybe.Just) {
                        ...
                        if ($790) {
                            var analysis = PureScript_Backend_Optimizer_Analysis.updated(level)(append(analysisOf(binding.value1.value0))(foldr(function ($2282) {
                                return append(analysisOf(PureScript_Backend_Optimizer_CoreFn.propValue($2282)));
            ...
            return function (body) {
                ...
                if (binding instanceof ExprSyntax && (binding.value1 instanceof PureScript_Backend_Optimizer_Syntax.Lit && binding.value1.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitRecord)) {
                    ...
                    if ($798 instanceof Data_Maybe.Just) {
                        var $799 = $798.value0.total === ($798.value0.access + $798.value0.update | 0);
                        if ($799) {
                            var analysis = foldr(function ($2283) {
                                return append(analysisOf(PureScript_Backend_Optimizer_CoreFn.propValue($2283)));
        ...
        return function (a) {
            return function (body) {
                ...
                if (a instanceof ExprSyntax && a.value1 instanceof PureScript_Backend_Optimizer_Syntax.CtorSaturated) {
                    var $807 = lookup(level)(v.usages);
                    if ($807 instanceof Data_Maybe.Just) {
                        var $808 = $807.value0.total === ($807.value0.access + $807["value0"]["case"] | 0);
                        if ($808) {
                            var analysis = foldr(function ($2284) {
                                return append(analysisOf(Data_Tuple.snd($2284)));
            ...
            return function (body) {
                ...
                if (binding instanceof ExprSyntax && (binding.value1 instanceof PureScript_Backend_Optimizer_Syntax.Lit && binding.value1.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitArray)) {
                    ...
                    if ($819 instanceof Data_Maybe.Just) {
                        var $820 = $819.value0.total === $819.value0.access;
                        if ($820) {
                            var analysis = foldr(function ($2285) {
                                return append(analysisOf($2285));
                            })(PureScript_Backend_Optimizer_Analysis.complex(PureScript_Backend_Optimizer_Analysis.NonTrivial.value)(PureScript_Backend_Optimizer_Analysis.bound(level)(v)))(binding.value1.value0.value0);
        ...
        return function (a) {
            return function (b) {
                ...
                if (a instanceof ExprSyntax && a.value1 instanceof PureScript_Backend_Optimizer_Syntax.Abs) {
                    var $828 = lookup(level)(v.usages);
                    if ($828 instanceof Data_Maybe.Just) {
                        var $829 = toUnfoldable($828.value0.arities);
                        if ($829.length === 1) {
                            var $830 = $829[0] === Data_Array_NonEmpty.length(a.value1.value0);
                            if ($830) {
...
var shouldInlineExternLiteral = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1871, column 29 - line 1878, column 30): " + [ v.constructor.name ]);
};
    ...
    return function (binding) {
        ...
        return function (v) {
            ...
            if (v instanceof ExprSyntax && (v.value1 instanceof PureScript_Backend_Optimizer_Syntax.Abs && (v.value1.value1 instanceof ExprSyntax && (v.value1.value1.value1 instanceof PureScript_Backend_Optimizer_Syntax.App && (v.value1.value1.value1.value0 instanceof ExprSyntax && v.value1.value1.value1.value0.value1 instanceof PureScript_Backend_Optimizer_Syntax.Local))))) {
                var $869 = eq6(level1)(v.value1.value1.value1.value0.value1.value1);
                if ($869) {
                    var $870 = Data_Array_NonEmpty.length(v.value1.value0) === Data_Array_NonEmpty.length(v.value1.value1.value1.value1);
                    if ($870) {
                        var $871 = and(Data_Array_NonEmpty.zipWith(isSameArg)(v.value1.value0)(v.value1.value1.value1.value1));
                        if ($871) {
        ...
        return function (a) {
            return function (body) {
                ...
                if (a instanceof ExprSyntax && a.value1 instanceof PureScript_Backend_Optimizer_Syntax.Branch) {
                    var $886 = v.size <= 128;
                    if ($886) {
                        var $887 = eq12(a.value0.result)(PureScript_Backend_Optimizer_Analysis.KnownNeutral.value);
                        if ($887) {
                            var $888 = lookup(level)(v.usages);
                            if ($888 instanceof Data_Maybe.Just) {
                                var $889 = $888.value0.total === ($888.value0.access + $888["value0"]["case"] | 0);
                                if ($889) {
...
var shouldDistributeBranchPrimOp2R = function (analysis1) {
    return function (branches) {
        return function (def) {
            return function (lhs) {
                return function (op2) {
                    var $896 = lessThanOrEq((unwrap(analysisOf(lhs))).complexity)(PureScript_Backend_Optimizer_Analysis.Deref.value);
                    if ($896) {
...
var shouldDistributeBranchPrimOp2L = function (analysis1) {
    return function (branches) {
        return function (def) {
            return function (op2) {
                return function (rhs) {
                    var $897 = lessThanOrEq((unwrap(analysisOf(rhs))).complexity)(PureScript_Backend_Optimizer_Analysis.Deref.value);
                    if ($897) {
...
var shouldDistributeBranchApps = function (analysis1) {
    return function (branches) {
        return function (def) {
            return function (spine) {
                var $898 = Data_Array_NonEmpty.all(function ($2287) {
                    return (function (v) {
                        return lessThanOrEq(v)(PureScript_Backend_Optimizer_Analysis.Deref.value);
                    })((function (v) {
                        return v.complexity;
                    })(unwrap(analysisOf($2287))));
                })(spine);
                if ($898) {
        ...
        return function (binding) {
            return function (body) {
                ...
                var powAnalysis = (function () {
                    ...
                    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1624, column 19 - line 1629, column 11): " + [ v.constructor.name ]);
                })();
...
var purely = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1358, column 1 - line 1358, column 21): " + [ v.constructor.name ]);
};
var primOpOrdNot = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 974, column 16 - line 980, column 16): " + [ v.constructor.name ]);
};
...
var neutralSpine = /* #__PURE__ */ (function () {
    var go = function (hd) {
        return function (v) {
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 566, column 11 - line 574, column 30): " + [ v.constructor.name ]);
        };
    };
    return foldl(go);
})();
var neutralApp = function (hd) {
    return function (spine) {
        ...
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 577, column 1 - line 577, column 77): " + [ hd.constructor.name, spine.constructor.name ]);
    };
};
...
var liftString = function ($2288) {
    return NeutLit.create(PureScript_Backend_Optimizer_CoreFn.LitString.create($2288));
};
...
var liftNumber = function ($2289) {
    return NeutLit.create(PureScript_Backend_Optimizer_CoreFn.LitNumber.create($2289));
};
var liftInt = function ($2290) {
    return NeutLit.create(PureScript_Backend_Optimizer_CoreFn.LitInt.create($2290));
};
var liftBoolean = function ($2291) {
    return NeutLit.create(PureScript_Backend_Optimizer_CoreFn.LitBoolean.create($2291));
};
...
var isKnownEffect = function ($2292) {
    return (function (v) {
...
var shouldInlineLet = function (level) {
    return function (a) {
        return function (b) {
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1804, column 3 - line 1814, column 43): " + [ v2.constructor.name ]);
        };
    };
};
    ...
    return function (acc) {
        return function (dir) {
            return alter(function (v) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 231, column 3 - line 235, column 35): " + [ v.constructor.name ]);
            })(ref);
        };
    };
};
    ...
    return function (f) {
        return function (as) {
            return function (k) {
                ...
                var v = findMap(function ($2294) {
                    return toFail(f($2294));
                })(as);
                if (v instanceof Data_Maybe.Just) {
                    return v.value0;
                };
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 2016, column 3 - line 2018, column 20): " + [ v.constructor.name ]);
            };
        };
    };
};
            ...
            if (v instanceof ExprRewrite) {
                return foldRewrite(v.value1)((function () {
                    ...
                    if (v.value1 instanceof RewriteUnpackOp) {
                        ...
                        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1946, column 11 - line 1954, column 117): " + [ v.value1.value2.constructor.name ]);
                    };
                    ...
                    if (v.value1 instanceof RewriteDistBranchesOp) {
                        ...
                        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1959, column 11 - line 1971, column 63): " + [ v.value1.value2.constructor.name ]);
                    };
                    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1938, column 7 - line 1971, column 63): " + [ v.value1.constructor.name ]);
                })());
            };
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1934, column 8 - line 1971, column 63): " + [ v.constructor.name ]);
        };
        return go;
    };
};
                    ...
                    function $tco_loop(f, ident1, binding1, k1) {
                        ...
                        if (binding1 instanceof SemLetRec) {
                            ...
                            return new SemLetRec(binding1.value0, function (nextBindings) {
                                return $lazy_makeLet(729)(ident1)(binding1.value1(nextBindings))(k1);
                            });
                        };
...
var $lazy_makeLet = /* #__PURE__ */ $runtime_lazy("makeLet", "PureScript.Backend.Optimizer.Semantics", function () {
    ...
    return $lazy_floatLetWith(692)(go);
});
var floatLetWith = /* #__PURE__ */ $lazy_floatLetWith(715);
var makeLet = /* #__PURE__ */ $lazy_makeLet(691);
                ...
                function $tco_loop(ident1, binding1, k1) {
                    if (binding1 instanceof SemLet) {
                        ...
                        return makeLet(binding1.value0)(binding1.value1)(function (nextBinding2) {
                            return $lazy_makeEffectBind(679)(ident1)(binding1.value2(nextBinding2))(k1);
                        });
                    };
                    if (binding1 instanceof SemEffectBind) {
                        ...
                        $tco_var_binding1 = binding1.value1;
                        $copy_k1 = function (nextBinding2) {
                            return $lazy_makeEffectBind(682)(ident1)(binding1.value2(nextBinding2))(k1);
                        };
                        return;
                    };
                    if (binding1 instanceof SemEffectDefer) {
                        ...
                        return new SemEffectDefer(floatLet(binding1.value0)(function (nextBinding2) {
                            return $lazy_makeEffectBind(685)(ident1)(nextBinding2)(k1);
                        }));
                    };
                    $tco_done = true;
...
var makeEffectBind = /* #__PURE__ */ $lazy_makeEffectBind(673);
        ...
        return function (spine) {
            var go = function (v) {
                return function (v1) {
                    ...
                    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 535, column 8 - line 546, column 36): " + [ v.constructor.name, v1.constructor.name ]);
                };
            };
...
var evalPrimOpOrdNumber = function (op) {
    return function (x) {
        return function (y) {
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 904, column 30 - line 910, column 18): " + [ op.constructor.name ]);
        };
    };
};
    ...
    return function (op) {
        return function (x) {
            return function (y) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 892, column 24 - line 898, column 18): " + [ op.constructor.name ]);
            };
        };
    };
};
...
var evalPrimOpNot = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 950, column 17 - line 970, column 46): " + [ v.constructor.name ]);
};
var evalEvalRef = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1065, column 15 - line 1069, column 24): " + [ v.constructor.name ]);
};
...
var effectfully = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1352, column 1 - line 1352, column 26): " + [ v.constructor.name ]);
};
                    ...
                    return function ($copy_def) {
                        ...
                        function $tco_loop(acc, conds, def) {
                            ...
                            if (v1 instanceof Data_Maybe.Nothing) {
                                ...
                                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 648, column 7 - line 652, column 20): " + [ v2.constructor.name ]);
                            };
                            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 636, column 22 - line 652, column 20): " + [ v1.constructor.name ]);
                        };
                        while (!$tco_done) {
    ...
    return function (x) {
        return function (y) {
            var v = function (v1) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 926, column 1 - line 926, column 105): " + [ op.constructor.name, x.constructor.name, y.constructor.name ]);
            };
            var $1162 = deref(x);
            if ($1162 instanceof NeutLit && $1162.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitInt) {
                var $1163 = deref(y);
                if ($1163 instanceof NeutLit && $1163.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitInt) {
                    if (op instanceof PureScript_Backend_Optimizer_Syntax.OpAdd) {
                        var res = $1162.value0.value0 + $1163.value0.value0 | 0;
                        var $1165 = $1163.value0.value0 > 0 && res < $1162.value0.value0 || $1163.value0.value0 < 0 && res > $1162.value0.value0;
                        if ($1165) {
                            return Data_Maybe.Nothing.value;
                        };
                    ...
                    if (op instanceof PureScript_Backend_Optimizer_Syntax.OpMultiply) {
                        var res = $1162.value0.value0 * $1163.value0.value0 | 0;
                        var $1166 = $1162.value0.value0 !== div(res)($1163.value0.value0);
                        if ($1166) {
                            return Data_Maybe.Nothing.value;
                        };
                        return new Data_Maybe.Just(liftInt(res));
                    ...
                    if (op instanceof PureScript_Backend_Optimizer_Syntax.OpSubtract) {
                        var res = $1162.value0.value0 - $1163.value0.value0 | 0;
                        var $1167 = $1163.value0.value0 > 0 && res > $1162.value0.value0 || $1163.value0.value0 < 0 && res < $1162.value0.value0;
                        if ($1167) {
                            return Data_Maybe.Nothing.value;
                        };
                        return new Data_Maybe.Just(liftInt(res));
                    ...
                    if (op instanceof PureScript_Backend_Optimizer_Syntax.OpDivide) {
                        return new Data_Maybe.Just(liftInt(div($1162.value0.value0)($1163.value0.value0)));
                    };
                    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 930, column 7 - line 944, column 33): " + [ op.constructor.name ]);
                };
                return v(true);
            };
            return v(true);
    ...
    return function (x) {
        return function (y) {
            var v = function (v1) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 913, column 1 - line 913, column 108): " + [ op.constructor.name, x.constructor.name, y.constructor.name ]);
            };
            var $1178 = deref(x);
            if ($1178 instanceof NeutLit && $1178.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitNumber) {
                ...
                if ($1179 instanceof NeutLit && $1179.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitNumber) {
                    return new Data_Maybe.Just(liftNumber((function () {
                        if (op instanceof PureScript_Backend_Optimizer_Syntax.OpAdd) {
                            return $1178.value0.value0 + $1179.value0.value0;
                        };
                        if (op instanceof PureScript_Backend_Optimizer_Syntax.OpMultiply) {
                            return $1178.value0.value0 * $1179.value0.value0;
                        };
                        ...
                        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 917, column 25 - line 921, column 26): " + [ op.constructor.name ]);
                    })()));
                };
                return v(true);
            };
        ...
        return function (spine) {
            return function (sem) {
                return function (v) {
                    ...
                    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1053, column 34 - line 1061, column 40): " + [ v.constructor.name ]);
                };
            };
        };
    };
            ...
            return function (last) {
                return function (sem) {
                    ...
                    if (ref instanceof EvalExtern) {
                        var $1196 = v.evalExternSpine(v)(ref.value0)(spine$prime);
                        if ($1196 instanceof Data_Maybe.Just) {
                            return $1196.value0;
                        };
                        return v1(true);
                    };
        ...
        function $tco_loop(env, v) {
            if (v instanceof PureScript_Backend_Optimizer_Syntax.Op1) {
                    ...
                    var v3 = function (v4) {
                        var v5 = function (v6) {
                            var v7 = function (v8) {
                                var v9 = function (v10) {
                                    var v11 = function (v12) {
                                        var v13 = function (v14) {
                                            ...
                                            return floatLet(v.value1)((function () {
                                                var $2295 = PureScript_Backend_Optimizer_Syntax.Op1.create(v.value0);
                                                return function ($2296) {
                                                    return NeutPrimOp.create($2295($2296));
                                                };
                                            })());
                                        };
                                        if (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpNumberNegate) {
                                            var $1208 = deref(v.value1);
                                            if ($1208 instanceof NeutLit && $1208.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitNumber) {
                                                $tco_done = true;
                                                return liftNumber(-$1208.value0.value0);
                                            };
                                            return v13(true);
                                        };
                                        return v13(true);
                                    ...
                                    if (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpIntNegate) {
                                        var $1213 = deref(v.value1);
                                        if ($1213 instanceof NeutLit && $1213.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitInt) {
                                            $tco_done = true;
                                            return liftInt(-$1213.value0.value0 | 0);
                                        };
                                        return v11(true);
                                    };
                                    return v11(true);
                                ...
                                if (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpArrayLength) {
                                    var $1218 = deref(v.value1);
                                    if ($1218 instanceof NeutLit && $1218.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitArray) {
                                        $tco_done = true;
                                        return liftInt(Data_Array.length($1218.value0.value0));
                                    };
                                    return v9(true);
                                };
                                return v9(true);
                            ...
                            if (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpIsTag) {
                                var $1223 = deref(v.value1);
                                if ($1223 instanceof NeutData) {
                                    $tco_done = true;
                                    return liftBoolean(eq(v.value0.value0)($1223.value0));
                                };
                                return v7(true);
                            };
                            return v7(true);
                        ...
                        if (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpIntBitNot) {
                            ...
                            if ($1232 instanceof NeutLit && $1232.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitInt) {
                                $tco_done = true;
                                return liftInt(~$1232.value0.value0);
                            };
                            return v5(true);
                        };
                        return v5(true);
                ...
                if (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpBooleanNot) {
                    ...
                    if ($1241 instanceof NeutLit && $1241.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitBoolean) {
                        $tco_done = true;
                        return liftBoolean(!$1241.value0.value0);
                    };
                    return v1(true);
                };
                return v1(true);
            ...
            if (v instanceof PureScript_Backend_Optimizer_Syntax.Op2) {
                var v1 = function (v2) {
                    var v3 = function (v4) {
                                    ...
                                    var v11 = function (v12) {
                                        var v13 = function (v14) {
                                            var v15 = function (v16) {
                                                var v17 = function (v18) {
                                                    var v19 = function (v20) {
                                                        var v21 = function (v22) {
                                                            var v23 = function (v24) {
                                                                                ...
                                                                                var v33 = function (v34) {
                                                                                    var v35 = function (v36) {
                                                                                        var v37 = function (v38) {
                                                                                            var v39 = function (v40) {
                                                                                                var v41 = function (v42) {
                                                                                                    var v43 = function (v44) {
                                                                                                        var v45 = function (v46) {
                                                                                                            var v47 = function (v48) {
                                                                                                                        ...
                                                                                                                        var v53 = function (v54) {
                                                                                                                            ...
                                                                                                                            return floatLet(v.value1)(function (x$prime) {
                                                                                                                                return floatLet(v.value2)(function (y$prime) {
                                                                                                                                    var $1259 = isAssocPrimOp(v.value0);
                                                                                                                                    if ($1259) {
                                                                                                                ...
                                                                                                                if (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpStringOrd) {
                                                                                                                    ...
                                                                                                                    if ($1272 instanceof NeutLit && $1272.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitString) {
                                                                                                                        var $1273 = deref(v.value2);
                                                                                                                        if ($1273 instanceof NeutLit && $1273.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitString) {
                                                                                                                            return liftBoolean(evalPrimOpOrd1(v.value0.value0)($1272.value0.value0)($1273.value0.value0));
                                                                                                                        };
                                                                                                                        return v49(true);
                                                                                                                    };
                                                                                                                    return v49(true);
                                                                                                            ...
                                                                                                            if (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpNumberOrd) {
                                                                                                                ...
                                                                                                                if ($1280 instanceof NeutLit && $1280.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitNumber) {
                                                                                                                    var $1281 = deref(v.value2);
                                                                                                                    if ($1281 instanceof NeutLit && $1281.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitNumber) {
                                                                                                                        return liftBoolean(evalPrimOpOrdNumber(v.value0.value0)($1280.value0.value0)($1281.value0.value0));
                                                                                                                    };
                                                                                                                    return v47(true);
                                                                                                                };
                                                                                                                return v47(true);
                                                                                                        ...
                                                                                                        if (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpNumberNum) {
                                                                                                            var $1288 = evalPrimOpNumNumber(v.value0.value0)(v.value1)(v.value2);
                                                                                                            if ($1288 instanceof Data_Maybe.Just) {
                                                                                                                return $1288.value0;
                                                                                                            };
                                                                                                            return v45(true);
                                                                                                        };
                                                                                                    ...
                                                                                                    if (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpNumberNum && v.value0.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpSubtract) {
                                                                                                        var $1292 = deref(v.value1);
                                                                                                        if ($1292 instanceof NeutLit && ($1292.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitNumber && $1292.value0.value0 === 0.0)) {
                                                                                                            $tco_var_env = env;
                                                                                                ...
                                                                                                if (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpIntOrd) {
                                                                                                    ...
                                                                                                    if ($1297 instanceof NeutLit && $1297.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitInt) {
                                                                                                        var $1298 = deref(v.value2);
                                                                                                        if ($1298 instanceof NeutLit && $1298.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitInt) {
                                                                                                            $tco_done = true;
                                                                                                            return liftBoolean(evalPrimOpOrd2(v.value0.value0)($1297.value0.value0)($1298.value0.value0));
                                                                                                        };
                                                                                                        return v41(true);
                                                                                                    };
                                                                                                    return v41(true);
                                                                                            ...
                                                                                            if (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpIntNum) {
                                                                                                var $1305 = evalPrimOpNumInt(v.value0.value0)(v.value1)(v.value2);
                                                                                        ...
                                                                                        if (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpIntNum && v.value0.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpSubtract) {
                                                                                            ...
                                                                                            if ($1309 instanceof NeutLit && ($1309.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitInt && $1309.value0.value0 === 0)) {
                                                                                                $tco_var_env = env;
                                                                ...
                                                                if (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpIntBitAnd) {
                                                                    ...
                                                                    if ($1349 instanceof NeutLit && $1349.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitInt) {
                                                                        var $1350 = deref(v.value2);
                                                                        if ($1350 instanceof NeutLit && $1350.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitInt) {
                                                                            $tco_done = true;
                                                                            return liftInt($1349.value0.value0 & $1350.value0.value0);
                                                                        };
                                                                        return v25(true);
                                                                    };
                                                                    return v25(true);
                                                            ...
                                                            if (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpCharOrd) {
                                                                ...
                                                                if ($1356 instanceof NeutLit && $1356.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitChar) {
                                                                    var $1357 = deref(v.value2);
                                                                    if ($1357 instanceof NeutLit && $1357.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitChar) {
                                                                        $tco_done = true;
                                                                        return liftBoolean(evalPrimOpOrd3(v.value0.value0)($1356.value0.value0)($1357.value0.value0));
                                                                    };
                                                                    return v23(true);
                                                                };
                                                                return v23(true);
                                                        ...
                                                        if (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpBooleanOrd) {
                                                            ...
                                                            if ($1364 instanceof NeutLit && $1364.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitBoolean) {
                                                                var $1365 = deref(v.value2);
                                                                if ($1365 instanceof NeutLit && $1365.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitBoolean) {
                                                                    $tco_done = true;
                                                                    return liftBoolean(evalPrimOpOrd4(v.value0.value0)($1364.value0.value0)($1365.value0.value0));
                                                                };
                                                                return v21(true);
                                                            };
                                                            return v21(true);
                                                    ...
                                                    if (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpBooleanOrd && v.value0.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpEq) {
                                                        ...
                                                        if ($1372 instanceof NeutLit && $1372.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitBoolean) {
                                                            if ($1372.value0.value0) {
                                                                $tco_done = true;
                                                                return v.value1;
                                                            };
                                                            $tco_var_env = env;
                                                ...
                                                if (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpBooleanOrd && v.value0.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpEq) {
                                                    var $1378 = deref(v.value1);
                                                    if ($1378 instanceof NeutLit && $1378.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitBoolean) {
                                                        if ($1378.value0.value0) {
                                                            $tco_done = true;
                                                            return v.value2;
                                                        };
                                                        $tco_var_env = env;
                        ...
                        if (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpBooleanAnd) {
                            ...
                            if ($1404 instanceof NeutLit && ($1404.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitBoolean && $1404.value0.value0)) {
                                $tco_done = true;
                                return v.value2;
                            };
                            return v5(true);
                    ...
                    if (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpBooleanAnd) {
                        ...
                        if ($1408 instanceof NeutLit && ($1408.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitBoolean && !$1408.value0.value0)) {
                            $tco_done = true;
                            return v.value2;
                        };
                        return v3(true);
                ...
                if (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpBooleanAnd) {
                    ...
                    if ($1412 instanceof NeutLit && ($1412.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitBoolean && !$1412.value0.value0)) {
                        $tco_done = true;
                        return v.value1;
                    };
                    return v1(true);
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 748, column 18 - line 888, column 45): " + [ v.constructor.name ]);
        };
        while (!$tco_done) {
        ...
        return function (a) {
            return function (b) {
                if (op instanceof Data_Either.Left) {
                    ...
                    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1031, column 5 - line 1035, column 52): " + [ v1.constructor.name ]);
                };
                if (op instanceof Data_Either.Right) {
                    return evalPrimOp(v)(new PureScript_Backend_Optimizer_Syntax.Op2(op.value0, a, b));
                };
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1029, column 35 - line 1037, column 36): " + [ op.constructor.name ]);
            };
        };
    };
};
            ...
            return function ($copy_v1) {
                ...
                function $tco_loop(env, op1, v, v1) {
                    ...
                    if (v instanceof SemAssocOp && v1 instanceof SemAssocOp) {
                        var $1447 = eq16(op1)(v.value0);
                        if ($1447) {
                            var $1448 = eq16(v.value0)(v1.value0);
                            if ($1448) {
    ...
    return function (lhs) {
        return function (accessor) {
            return floatLet(lhs)(function (v) {
                ...
                var v1 = function (v2) {
                    var v3 = function (v4) {
                        var v5 = function (v6) {
                            ...
                            if (v instanceof NeutData) {
                                if (accessor instanceof PureScript_Backend_Optimizer_Syntax.GetCtorField) {
                                    var $1466 = Data_Array.index(v.value4)(accessor.value5);
                                    if ($1466 instanceof Data_Maybe.Just) {
                                        return $1466.value0.value1;
                                    };
                                    return v7(true);
                                };
                                return v7(true);
                        ...
                        if (v instanceof NeutLit && v.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitArray) {
                            if (accessor instanceof PureScript_Backend_Optimizer_Syntax.GetIndex) {
                                var $1483 = Data_Array.index(v.value0.value0)(accessor.value0);
                    ...
                    if (v instanceof NeutUpdate) {
                        if (accessor instanceof PureScript_Backend_Optimizer_Syntax.GetProp) {
                            ...
                            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 601, column 9 - line 605, column 42): " + [ v4.constructor.name ]);
                        };
                        return v3(true);
                    };
                    return v3(true);
                ...
                if (v instanceof NeutLit && v.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitRecord) {
                    if (accessor instanceof PureScript_Backend_Optimizer_Syntax.GetProp) {
                        var $1503 = Data_Array.findMap(function (v2) {
                            return voidLeft(guard(v2.value0 === accessor.value0))(v2.value1);
                        })(v.value0.value0);
                        if ($1503 instanceof Data_Maybe.Just) {
                            return $1503.value0;
                        };
                        return v1(true);
                    };
...
var build = function (ctx) {
    return function (v) {
        ...
        var v1 = function (v2) {
            var v3 = function (v4) {
                var v5 = function (v6) {
                    var v7 = function (v8) {
                        var v9 = function (v10) {
                            var v11 = function (v12) {
                                var v13 = function (v14) {
                                    var v15 = function (v16) {
                                        var v17 = function (v18) {
                                            var v19 = function (v20) {
                                                var v21 = function (v22) {
                                                    var v23 = function (v24) {
                                                        ...
                                                        if (v instanceof PureScript_Backend_Optimizer_Syntax.PrimOp && (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.Op2 && (v.value0.value2 instanceof ExprSyntax && v.value0.value2.value1 instanceof PureScript_Backend_Optimizer_Syntax.Branch))) {
                                                            var $1586 = shouldDistributeBranchPrimOp2R(v.value0.value2.value0)(v.value0.value2.value1.value0)(v.value0.value2.value1.value1)(v.value0.value1)(v.value0.value0);
                                                            if ($1586 instanceof Data_Maybe.Just) {
                                                                return $1586.value0;
                                                            };
                                                            return v25(true);
                                                        };
                                                    ...
                                                    if (v instanceof PureScript_Backend_Optimizer_Syntax.PrimOp && (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.Op2 && (v.value0.value1 instanceof ExprSyntax && v.value0.value1.value1 instanceof PureScript_Backend_Optimizer_Syntax.Branch))) {
                                                        var $1597 = shouldDistributeBranchPrimOp2L(v.value0.value1.value0)(v.value0.value1.value1.value0)(v.value0.value1.value1.value1)(v.value0.value0)(v.value0.value2);
                                                        if ($1597 instanceof Data_Maybe.Just) {
                                                            return $1597.value0;
                                                        };
                                                        return v23(true);
                                                    };
                                                ...
                                                if (v instanceof PureScript_Backend_Optimizer_Syntax.PrimOp && (v.value0 instanceof PureScript_Backend_Optimizer_Syntax.Op1 && (v.value0.value1 instanceof ExprSyntax && v.value0.value1.value1 instanceof PureScript_Backend_Optimizer_Syntax.Branch))) {
                                                    var $1608 = shouldDistributeBranchPrimOp1(v.value0.value1.value0)(v.value0.value1.value1.value0)(v.value0.value1.value1.value1)(v.value0.value0);
                                            ...
                                            if (v instanceof PureScript_Backend_Optimizer_Syntax.Accessor && (v.value0 instanceof ExprSyntax && v.value0.value1 instanceof PureScript_Backend_Optimizer_Syntax.Branch)) {
                                                var $1618 = shouldDistributeBranchAccessor(v.value0.value0)(v.value0.value1.value0)(v.value0.value1.value1)(v.value1);
                                                if ($1618 instanceof Data_Maybe.Just) {
                                                    return $1618.value0;
                                                };
                                                return v19(true);
                                            };
                                        ...
                                        if (v instanceof PureScript_Backend_Optimizer_Syntax.UncurriedApp && (v.value0 instanceof ExprSyntax && v.value0.value1 instanceof PureScript_Backend_Optimizer_Syntax.Branch)) {
                                            var $1627 = shouldDistributeBranchUncurriedApps(v.value0.value0)(v.value0.value1.value0)(v.value0.value1.value1)(v.value1);
                                    ...
                                    if (v instanceof PureScript_Backend_Optimizer_Syntax.App && (v.value0 instanceof ExprSyntax && v.value0.value1 instanceof PureScript_Backend_Optimizer_Syntax.Branch)) {
                                        var $1636 = shouldDistributeBranchApps(v.value0.value0)(v.value0.value1.value0)(v.value0.value1.value1)(v.value1);
                                ...
                                if (v instanceof PureScript_Backend_Optimizer_Syntax.Let) {
                                    var $1645 = shouldEtaReduce(v.value1)(v.value2)(v.value3);
                            ...
                            if (v instanceof PureScript_Backend_Optimizer_Syntax.Let) {
                                var $1652 = shouldDistributeBranches(v.value0)(v.value1)(v.value2)(v.value3);
                        ...
                        if (v instanceof PureScript_Backend_Optimizer_Syntax.Let) {
                            var $1659 = shouldUnpackArray(v.value0)(v.value1)(v.value2)(v.value3);
                    ...
                    if (v instanceof PureScript_Backend_Optimizer_Syntax.Let) {
                        var $1666 = shouldUnpackCtor(v.value0)(v.value1)(v.value2)(v.value3);
                        if ($1666 instanceof Data_Maybe.Just) {
                            return $1666.value0;
                        };
                        return v7(true);
                    };
                ...
                if (v instanceof PureScript_Backend_Optimizer_Syntax.Let) {
                    var $1673 = shouldUnpackUpdate(v.value0)(v.value1)(v.value2)(v.value3);
                    if ($1673 instanceof Data_Maybe.Just) {
                        return $1673.value0;
                    };
                    return v5(true);
                };
            ...
            if (v instanceof PureScript_Backend_Optimizer_Syntax.Let) {
                var $1680 = shouldUnpackRecord(v.value0)(v.value1)(v.value2)(v.value3);
                if ($1680 instanceof Data_Maybe.Just) {
                    return $1680.value0;
                };
                return v3(true);
            };
        ...
        if (v instanceof PureScript_Backend_Optimizer_Syntax.Let) {
            var $1687 = shouldUncurryAbs(v.value0)(v.value1)(v.value2)(v.value3);
    ...
    return function (v) {
        return function (v1) {
            ...
            if (v1 instanceof ExprSyntax && v1.value1 instanceof PureScript_Backend_Optimizer_Syntax.Branch) {
                var $1719 = Data_Array_NonEmpty.head(v1.value1.value0);
                if ($1719.value0 instanceof ExprSyntax && ($1719.value0.value1 instanceof PureScript_Backend_Optimizer_Syntax.PrimOp && ($1719.value0.value1.value0 instanceof PureScript_Backend_Optimizer_Syntax.Op1 && $1719.value0.value1.value0.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpBooleanNot))) {
                    var $1720 = eq18(v.value0)($1719.value0.value1.value0.value1);
                    if ($1720) {
                        return new Data_Maybe.Just(buildBranchCond(ctx)(new PureScript_Backend_Optimizer_Syntax.Pair(v.value0, v.value1))($1719.value1));
                    };
                    return v2(true);
                };
                return v2(true);
    ...
    return function (pair) {
        return function (def1) {
            ...
            if (pair.value1 instanceof ExprSyntax && pair.value1.value1 instanceof PureScript_Backend_Optimizer_Syntax.Branch) {
                var $1735 = Data_Array_NonEmpty.toArray(pair.value1.value1.value0);
                if ($1735.length === 1) {
                    var $1736 = eq18(def1)(pair.value1.value1.value1);
                    if ($1736) {
                        return new Data_Maybe.Just(buildBranchCond(ctx)(new PureScript_Backend_Optimizer_Syntax.Pair(build(ctx)(new PureScript_Backend_Optimizer_Syntax.PrimOp(new PureScript_Backend_Optimizer_Syntax.Op2(PureScript_Backend_Optimizer_Syntax.OpBooleanAnd.value, pair.value0, $1735[0].value0))), $1735[0].value1))(def1));
                    };
                    return v(true);
                };
                return v(true);
                    ...
                    var v4 = function (v5) {
                        var v6 = function (v7) {
                            var v8 = function (v9) {
                                ...
                                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1592, column 1 - line 1592, column 89): " + [ ctx.constructor.name, pair.constructor.name, def.constructor.name ]);
                            };
                        ...
                        var $1760 = simplifyCondRedundantElse(ctx)(pair)(def);
                        if ($1760 instanceof Data_Maybe.Just) {
                            return $1760.value0;
                        };
                        return v6(true);
                    };
                    var $1765 = simplifyCondLiftAnd(ctx)(pair)(def);
                    if ($1765 instanceof Data_Maybe.Just) {
                        return $1765.value0;
                    };
                    return v4(true);
                };
                var $1770 = simplifyCondBoolean(ctx)(pair)(def);
                if ($1770 instanceof Data_Maybe.Just) {
                    return $1770.value0;
                };
                return v2(true);
            };
            var $1775 = simplifyCondIsTag(ctx)(pair)(def);
            if ($1775 instanceof Data_Maybe.Just) {
                return $1775.value0;
            };
            return v(true);
        };
    ...
    var go = function (ctx) {
        return function (v) {
            ...
            if (v instanceof SemLet) {
                ...
                return build(ctx)(new PureScript_Backend_Optimizer_Syntax.Let(v.value0, v1.value0, $lazy_quote(1374)(purely(ctx))(v.value1), $lazy_quote(1374)(v1.value1)(v.value2(new SemRef(new EvalLocal(v.value0, v1.value0), [  ], Data_Lazy.defer(function (v2) {
            ...
            if (v instanceof SemLetRec) {
                ...
                return build(ctx)(new PureScript_Backend_Optimizer_Syntax.LetRec(v1.value0, map1(map6(function (b) {
                    return $lazy_quote(1383)(purely(v1.value1))(b(neutBindings));
                }))(v.value0), $lazy_quote(1384)(v1.value1)(v.value1(neutBindings))));
            };
            if (v instanceof SemEffectBind) {
                var ctx$prime = effectfully(ctx);
                var v1 = nextLevel(ctx$prime);
                return build(ctx)(new PureScript_Backend_Optimizer_Syntax.EffectBind(v.value0, v1.value0, $lazy_quote(1388)(ctx$prime)(v.value1), $lazy_quote(1388)(v1.value1)(v.value2(new NeutLocal(v.value0, v1.value0)))));
            };
            if (v instanceof SemEffectPure) {
                return build(ctx)(new PureScript_Backend_Optimizer_Syntax.EffectPure($lazy_quote(1390)(purely(ctx))(v.value0)));
            };
            if (v instanceof SemEffectDefer) {
                return build(ctx)(new PureScript_Backend_Optimizer_Syntax.EffectDefer($lazy_quote(1392)(effectfully(ctx))(v.value0)));
            };
            if (v instanceof SemBranch) {
                var ctx$prime = purely(ctx);
                var quoteCond = function (v1) {
                    return new PureScript_Backend_Optimizer_Syntax.Pair($lazy_quote(1395)(ctx$prime)(Data_Lazy.force(v1.value0)), $lazy_quote(1395)(ctx)(Data_Lazy.force(v1.value1)));
                };
                var branches$prime = map1(quoteCond)(v.value0);
                return foldr1(buildBranchCond(ctx))($lazy_quote(1397)(ctx)(Data_Lazy.force(v.value1)))(branches$prime);
            };
            if (v instanceof SemRef) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1401, column 7 - line 1405, column 57): " + [ v.value0.constructor.name ]);
            };
            if (v instanceof SemLam) {
                var v1 = nextLevel(ctx);
                return build(ctx)(new PureScript_Backend_Optimizer_Syntax.Abs(Data_Array_NonEmpty.singleton(new Data_Tuple.Tuple(v.value0, v1.value0)), $lazy_quote(1408)(purely(v1.value1))(v.value1(new NeutLocal(v.value0, v1.value0)))));
            };
                        ...
                        return function ($copy_v1) {
                            ...
                            function $tco_loop(ctx$prime, idents, v1) {
                                ...
                                if (v1 instanceof MkFnApplied) {
                                    $tco_done = true;
                                    return build(ctx$prime)(new PureScript_Backend_Optimizer_Syntax.UncurriedAbs(idents, $lazy_quote(1416)(purely(ctx$prime))(v1.value0)));
                                };
                                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1411, column 28 - line 1416, column 72): " + [ v1.constructor.name ]);
                            };
                            while (!$tco_done) {
                    ...
                    return function ($copy_idents) {
                        return function ($copy_v1) {
                            ...
                            function $tco_loop(ctx$prime, idents, v1) {
                                ...
                                if (v1 instanceof MkFnApplied) {
                                    $tco_done1 = true;
                                    return build(ctx$prime)(new PureScript_Backend_Optimizer_Syntax.UncurriedEffectAbs(idents, $lazy_quote(1425)(purely(ctx$prime))(v1.value0)));
                                };
                                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1420, column 28 - line 1425, column 78): " + [ v1.constructor.name ]);
                            };
                            while (!$tco_done1) {
                                $tco_result = $tco_loop($tco_var_ctx$prime, $tco_var_idents, $copy_v1);
                            };
                ...
                return PureScript_Backend_Optimizer_Utils.foldl1Array(function (a) {
                    return function (b) {
                        if (v.value0 instanceof Data_Either.Left) {
                            return build(ctx)(new PureScript_Backend_Optimizer_Syntax.App(build(ctx)(new PureScript_Backend_Optimizer_Syntax.Var(v.value0.value0)), Data_Array_NonEmpty["cons$prime"](a)([ $lazy_quote(1431)(ctx)(b) ])));
                        };
                        if (v.value0 instanceof Data_Either.Right) {
                            return build(ctx)(new PureScript_Backend_Optimizer_Syntax.PrimOp(new PureScript_Backend_Optimizer_Syntax.Op2(v.value0.value0, a, $lazy_quote(1433)(ctx)(b))));
                        };
                        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1429, column 19 - line 1433, column 62): " + [ v.value0.constructor.name ]);
                    };
                })($lazy_quote(1435)(ctx))(v.value1);
            };
            ...
            if (v instanceof NeutData) {
                return build(ctx)(new PureScript_Backend_Optimizer_Syntax.CtorSaturated(v.value0, v.value1, v.value2, v.value3, map4(map6($lazy_quote(1444)(ctx)))(v.value4)));
            };
            ...
            if (v instanceof NeutUncurriedApp) {
                var ctx$prime = purely(ctx);
                var hd$prime = $lazy_quote(1449)(ctx$prime)(v.value0);
                return build(ctx)(new PureScript_Backend_Optimizer_Syntax.UncurriedApp(hd$prime, map4($lazy_quote(1450)(ctx$prime))(v.value1)));
            };
            if (v instanceof NeutUncurriedEffectApp) {
                var ctx$prime = purely(ctx);
                var hd$prime = $lazy_quote(1453)(ctx$prime)(v.value0);
                return build(ctx)(new PureScript_Backend_Optimizer_Syntax.UncurriedEffectApp(hd$prime, map4($lazy_quote(1454)(ctx$prime))(v.value1)));
            };
            if (v instanceof NeutApp) {
                var ctx$prime = purely(ctx);
                var hd$prime = $lazy_quote(1457)(ctx$prime)(v.value0);
                var v1 = Data_Array_NonEmpty.fromArray(map4($lazy_quote(1458)(ctx$prime))(v.value1));
                if (v1 instanceof Data_Maybe.Nothing) {
                    return hd$prime;
                };
                if (v1 instanceof Data_Maybe.Just) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1458, column 7 - line 1462, column 35): " + [ v1.constructor.name ]);
            };
            if (v instanceof NeutAccessor) {
                return build(ctx)(new PureScript_Backend_Optimizer_Syntax.Accessor($lazy_quote(1464)(ctx)(v.value0), v.value1));
            };
            if (v instanceof NeutUpdate) {
                return build(ctx)(new PureScript_Backend_Optimizer_Syntax.Update($lazy_quote(1466)(ctx)(v.value0), map4(map5($lazy_quote(1466)(ctx)))(v.value1)));
            };
            if (v instanceof NeutLit) {
                return build(ctx)(new PureScript_Backend_Optimizer_Syntax.Lit(map8($lazy_quote(1468)(ctx))(v.value0)));
            };
            if (v instanceof NeutPrimOp) {
                return build(ctx)(new PureScript_Backend_Optimizer_Syntax.PrimOp(map9($lazy_quote(1470)(ctx))(v.value0)));
            };
            if (v instanceof NeutPrimEffect) {
                return build(ctx)(new PureScript_Backend_Optimizer_Syntax.PrimEffect(map10($lazy_quote(1472)(purely(ctx)))(v.value0)));
            };
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1367, column 12 - line 1476, column 27): " + [ v.constructor.name ]);
        };
    };
    return go;
});
var quote = /* #__PURE__ */ $lazy_quote(1364);
                    ...
                    return function (v) {
                        return function (v1) {
                            ...
                            if (v instanceof SemLam && v1 instanceof Data_List_Types.Cons) {
                                return makeLet(Data_Maybe.Nothing.value)(v1.value0)(function (nextArg) {
                                    return go(Data_Maybe.Nothing.value)(env$prime)(v.value1(nextArg))(v1.value1);
                                });
                            };
                            if (v instanceof SemRef && v1 instanceof Data_List_Types.Cons) {
                                var fn = (function () {
                                    if (mbTy instanceof Data_Maybe.Just) {
                                        return new SemTyped(mbTy.value0, new SemRef(v.value0, v.value1, v.value2));
                                    };
                                    if (mbTy instanceof Data_Maybe.Nothing) {
                                        return new SemRef(v.value0, v.value1, v.value2);
                                    };
                                    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 446, column 14 - line 448, column 39): " + [ mbTy.constructor.name ]);
                                })();
                                return go(Data_Maybe.Nothing.value)(env$prime)(evalRef(env$prime)(v.value0)(v.value1)(new ExternApp([ v1.value0 ]))(v.value2))(v1.value1);
                            };
                            if (v instanceof SemLet) {
                            ...
                            if (v1 instanceof Data_List_Types.Nil) {
                                ...
                                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 466, column 7 - line 468, column 22): " + [ mbTy.constructor.name ]);
                            };
                            var fn$prime = (function () {
                                ...
                                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 472, column 15 - line 474, column 24): " + [ mbTy.constructor.name ]);
                            })();
...
var evalMkFn = function (env) {
    return function (n) {
        return function (sem) {
            ...
            if (Data_Boolean.otherwise) {
                if (sem instanceof SemLam) {
                    return new MkFnNext(sem.value0, (function () {
                        var $2297 = evalMkFn(env)(n - 1 | 0);
                        return function ($2298) {
                            return $2297(sem.value1($2298));
                        };
                    })());
                };
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1974, column 1 - line 1974, column 68): " + [ env.constructor.name, n.constructor.name, sem.constructor.name ]);
        };
    };
};
                ...
                return function ($copy_v) {
                    ...
                    function $tco_loop(mbTy, v) {
                        ...
                        if (v instanceof SemRef) {
                            ...
                            return guardFailOver1(identity)(spine)(function (spine$prime) {
                                var fn = (function () {
                                    ...
                                    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 491, column 18 - line 493, column 43): " + [ mbTy.constructor.name ]);
                                })();
                        ...
                        var finalHd = (function () {
                            ...
                            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 503, column 19 - line 505, column 25): " + [ mbTy.constructor.name ]);
                        })();
                        $tco_done = true;
...
var evalSpine = function (env) {
    var go = function (hd) {
        return function (v) {
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 552, column 11 - line 560, column 34): " + [ v.constructor.name ]);
        };
    };
    return foldl(go);
};
    ...
    return function (hd) {
        var go = function (acc) {
            return function (n) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1990, column 3 - line 1994, column 42): " + [ acc.constructor.name, n.constructor.name ]);
            };
        };
        return go([  ]);
    };
                ...
                return function ($copy_v) {
                    ...
                    function $tco_loop(mbTy, v) {
                        ...
                        var finalHd = (function () {
                            ...
                            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 526, column 19 - line 528, column 25): " + [ mbTy.constructor.name ]);
                        })();
                        $tco_done = true;
                    ...
                    return function (next) {
                        return function (env$prime) {
                            return new MkFnNext(v.value0, (function () {
                                var $2299 = bindLocal(env$prime);
                                return function ($2300) {
                                    return next($2299(One.create($2300)));
                                };
                            })());
                        };
                    };
                })((function () {
                    var $2301 = Data_Function.flip(eval4)(body);
                    return function ($2302) {
                        return MkFnApplied.create($2301($2302));
                    };
                })())(args)(env));
            };
        };
            ...
            return function (v1) {
                if (v1 instanceof PureScript_Backend_Optimizer_Syntax.Var) {
                    ...
                    if (v2 instanceof Data_Maybe.Nothing) {
                        return new SemRef(new EvalExtern(v1.value0), [  ], Data_Lazy.defer(function (v3) {
                            ...
                            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 264, column 13 - line 268, column 29): " + [ v4.constructor.name ]);
                        }));
                    };
                    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 259, column 7 - line 268, column 29): " + [ v2.constructor.name ]);
                };
                if (v1 instanceof PureScript_Backend_Optimizer_Syntax.Local) {
                    ...
                    if (v2 instanceof Data_Maybe.Just && v2.value0 instanceof Group) {
                        var $1957 = bindFlipped(Data_Function.flip(lookup1)(v2.value0.value0))(v1.value0);
                        if ($1957 instanceof Data_Maybe.Just) {
                            return Data_Lazy.force($1957.value0);
                        };
                        return v3(true);
                    };
                    return v3(true);
                ...
                if (v1 instanceof PureScript_Backend_Optimizer_Syntax.UncurriedAbs) {
                    var loop = function (env$prime) {
                        return function (v2) {
                            ...
                            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 282, column 21 - line 287, column 53): " + [ v2.constructor.name ]);
                        };
                    };
                ...
                if (v1 instanceof PureScript_Backend_Optimizer_Syntax.UncurriedEffectAbs) {
                    var loop = function (env$prime) {
                        return function (v2) {
                            ...
                            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 293, column 21 - line 298, column 53): " + [ v2.constructor.name ]);
                        };
                    };
                ...
                if (v1 instanceof PureScript_Backend_Optimizer_Syntax.Abs) {
                    return PureScript_Backend_Optimizer_Utils.foldr1Array(function (v2) {
                        return function (next) {
                            return function (env$prime) {
                                return new SemLam(v2.value0, (function () {
                                    var $2303 = bindLocal(env$prime);
                                    return function ($2304) {
                                        return next($2303(One.create($2304)));
                                    };
                                })());
                            };
                        };
                        ...
                        return function (env$prime) {
                            return new SemLam(v2.value0, (function () {
                                var $2305 = Data_Function.flip(eval4)(v1.value1);
                                var $2306 = bindLocal(env$prime);
                                return function ($2307) {
                                    return $2305($2306(One.create($2307)));
                                };
                            })());
                        };
                    })(v1.value0)(v);
                ...
                if (v1 instanceof PureScript_Backend_Optimizer_Syntax.Let) {
                    return makeLet(v1.value0)(eval4(v)(v1.value2))((function () {
                        var $2308 = Data_Function.flip(eval4)(v1.value3);
                        var $2309 = bindLocal(v);
                        return function ($2310) {
                            return $2308($2309(One.create($2310)));
                        };
                    })());
                };
                if (v1 instanceof PureScript_Backend_Optimizer_Syntax.LetRec) {
                    var bindGroup = function (sem) {
                        var $2311 = Data_Function.flip(eval4)(sem);
                        var $2312 = bindLocal(v);
                        return function ($2313) {
                            return $2311($2312(Group.create($2313)));
                        };
                    };
                ...
                if (v1 instanceof PureScript_Backend_Optimizer_Syntax.EffectBind) {
                    return makeEffectBind(v1.value0)(eval4(v)(v1.value2))((function () {
                        var $2314 = Data_Function.flip(eval4)(v1.value3);
                        var $2315 = bindLocal(v);
                        return function ($2316) {
                            return $2314($2315(One.create($2316)));
                        };
                    })());
                };
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 257, column 22 - line 339, column 30): " + [ v1.constructor.name ]);
            };
        }
    };
};
                        ...
                        if (v instanceof ExprRewrite) {
                            ...
                            if (v.value1 instanceof RewriteUnpackOp) {
                                if (v.value1.value2 instanceof UnpackRecord) {
                                    ...
                                    return foldr(function (v1) {
                                        ...
                                        var $2317 = Data_Function.flip($$eval($lazy_evalBackendExpr(0)))(v.value1.value3);
                                        var $2318 = bindLocal(env);
                                        return function ($2319) {
                                            return $2317($2318(One.create(NeutLit.create(PureScript_Backend_Optimizer_CoreFn.LitRecord.create($2319)))));
                                        };
                                ...
                                if (v.value1.value2 instanceof UnpackUpdate) {
                                    ...
                                    return makeLet(Data_Maybe.Nothing.value)($$eval($lazy_evalBackendExpr(0))(env)(v.value1.value2.value0))(function (hd$prime) {
                                        return foldr(function (v1) {
                                            ...
                                            var $2320 = Data_Function.flip($$eval($lazy_evalBackendExpr(0)))(v.value1.value3);
                                            var $2321 = bindLocal(env);
                                            var $2322 = NeutUpdate.create(hd$prime);
                                            return function ($2323) {
                                                return $2320($2321(One.create($2322($2323))));
                                            };
                                ...
                                if (v.value1.value2 instanceof UnpackArray) {
                                    ...
                                    return foldr(function (expr) {
                                        ...
                                        var $2324 = Data_Function.flip($$eval($lazy_evalBackendExpr(0)))(v.value1.value3);
                                        var $2325 = bindLocal(env);
                                        return function ($2326) {
                                            return $2324($2325(One.create(NeutLit.create(PureScript_Backend_Optimizer_CoreFn.LitArray.create($2326)))));
                                        };
                                    })())(v.value1.value2.value0)([  ]);
                                };
                                if (v.value1.value2 instanceof UnpackData) {
                                    ...
                                    return foldr(function (v1) {
                                        ...
                                        var $2327 = Data_Function.flip($$eval($lazy_evalBackendExpr(0)))(v.value1.value3);
                                        var $2328 = bindLocal(env);
                                        var $2329 = NeutData.create(v.value1.value2.value0)(v.value1.value2.value1)(v.value1.value2.value2)(v.value1.value2.value3);
                                        return function ($2330) {
                                            return $2327($2328(One.create($2329($2330))));
                                        };
                                    })())(v.value1.value2.value4)([  ]);
                                };
                                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 355, column 13 - line 392, column 21): " + [ v.value1.value2.constructor.name ]);
                            };
                            if (v.value1 instanceof RewriteDistBranchesLet) {
                                $tco_done = true;
                                return rewriteBranches((function () {
                                    var $2331 = Data_Function.flip($$eval($lazy_evalBackendExpr(0)))(v.value1.value4);
                                    var $2332 = bindLocal(env);
                                    return function ($2333) {
                                        return $2331($2332(One.create($2333)));
                                    };
                            ...
                            if (v.value1 instanceof RewriteDistBranchesOp) {
                                var dist = (function () {
                                    ...
                                    if (v.value1.value2 instanceof DistPrimOp1) {
                                        var $2334 = evalPrimOp(env);
                                        var $2335 = PureScript_Backend_Optimizer_Syntax.Op1.create(v.value1.value2.value0);
                                        return function ($2336) {
                                            return $2334($2335($2336));
                                        };
                                    };
                                    if (v.value1.value2 instanceof DistPrimOp2L) {
                                        var $2337 = evalPrimOp(env);
                                        var $2338 = Data_Function.flip(PureScript_Backend_Optimizer_Syntax.Op2.create(v.value1.value2.value0))($$eval($lazy_evalBackendExpr(0))(env)(v.value1.value2.value1));
                                        return function ($2339) {
                                            return $2337($2338($2339));
                                        };
                                    };
                                    if (v.value1.value2 instanceof DistPrimOp2R) {
                                        var $2340 = evalPrimOp(env);
                                        var $2341 = PureScript_Backend_Optimizer_Syntax.Op2.create(v.value1.value2.value1)($$eval($lazy_evalBackendExpr(0))(env)(v.value1.value2.value0));
                                        return function ($2342) {
                                            return $2340($2341($2342));
                                        };
                                    };
                                    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 399, column 20 - line 411, column 58): " + [ v.value1.value2.constructor.name ]);
                                })();
                                $tco_done = true;
                            ...
                            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 346, column 9 - line 411, column 58): " + [ v.value1.constructor.name ]);
                        };
                        if (v instanceof ExprSyntax) {
                            $tco_done = true;
                            return $$eval(evalBackendSyntax($lazy_evalBackendExpr(0)))(env)(v.value1);
                        };
                        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 344, column 14 - line 413, column 22): " + [ v.constructor.name ]);
                    };
                    while (!$tco_done) {
                        $tco_result = $tco_loop($tco_var_env, $copy_v);
                    };
...
var evalBackendExpr = /* #__PURE__ */ $lazy_evalBackendExpr(341);
                    ...
                    return function (originalExpr) {
                        var goStep = function (n) {
                            return function (expr1) {
                                if (n === 0) {
                                    var name = foldMap2(function ($2343) {
                                        return (function (v1) {
                                            return v1 + ".";
                                        })(unwrap($2343));
                                    })(v.value0) + v.value1;
                                ...
                                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1916, column 3 - line 1916, column 60): " + [ n.constructor.name, expr1.constructor.name ]);
                            };
                        };
...
var analysisFromDirective = function (v) {
    return function (v1) {
        ...
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1287, column 52 - line 1295, column 29): " + [ v1.constructor.name ]);
    };
};
    ...
    return function (ref) {
        return function (acc) {
            return function (group) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Semantics (line 1080, column 1 - line 1080, column 82): " + [ env.constructor.name, ref.constructor.name, acc.constructor.name, group.constructor.name ]);
            };
        };
    };
};
        ...
        return function (v1) {
            return function (spine) {
                    ...
                    if (v1.value1 instanceof ExternDict) {
                        ...
                        if ($2136 instanceof Data_Maybe.Just) {
                            ...
                            if (v3 instanceof Data_Maybe.Just && v3.value0 instanceof InlineAlways) {
                                return new Data_Maybe.Just(eval2(envForGroup(v)(ref)(new InlineProp(spine[0].value0.value0))(v1.value1.value0))($2136.value0.value1));
                            };
                            if (v3 instanceof Data_Maybe.Just && v3.value0 instanceof InlineArity) {
                                return Data_Maybe.Nothing.value;
                            };
                            if (shouldInlineExternAccessor(qual)($2136.value0.value0)($2136.value0.value1)(spine[0].value0)) {
                                return new Data_Maybe.Just(eval2(envForGroup(v)(ref)(new InlineProp(spine[0].value0.value0))(v1.value1.value0))($2136.value0.value1));
                            };
                            return Data_Maybe.Nothing.value;
                        };
                ...
                if (spine.length === 2 && (spine[0] instanceof ExternAccessor && (spine[0].value0 instanceof PureScript_Backend_Optimizer_Syntax.GetProp && spine[1] instanceof ExternApp))) {
                    ...
                    if (v1.value1 instanceof ExternDict) {
                        var $2159 = PureScript_Backend_Optimizer_CoreFn.findProp(spine[0].value0.value0)(v1.value1.value1);
                        if ($2159 instanceof Data_Maybe.Just) {
                            var ref = new EvalExtern(qual);
                            var v3 = bind(lookup3(ref)(v.directives))(lookup2(new InlineProp(spine[0].value0.value0)));
                            if (v3 instanceof Data_Maybe.Just && v3.value0 instanceof InlineNever) {
                                return new Data_Maybe.Just(neutralSpine(new NeutStop(qual))(spine));
                            ...
                            if (v3 instanceof Data_Maybe.Just && v3.value0 instanceof InlineAlways) {
                                return new Data_Maybe.Just(evalApp(v)(eval2(envForGroup(v)(ref)(new InlineProp(spine[0].value0.value0))(v1.value1.value0))($2159.value0.value1))(spine[1].value0));
                            };
                            if (v3 instanceof Data_Maybe.Just && v3.value0 instanceof InlineArity) {
                            ...
                            if (shouldInlineExternApp(qual)($2159.value0.value0)($2159.value0.value1)(spine[1].value0)) {
                                return new Data_Maybe.Just(evalApp(v)(eval2(envForGroup(v)(ref)(new InlineProp(spine[0].value0.value0))(v1.value1.value0))($2159.value0.value1))(spine[1].value0));
                            };
                            return Data_Maybe.Nothing.value;
                        };
                ...
                var v2 = function (v3) {
                    var v4 = function (v5) {
                        ...
                        var $2217 = Data_Array.uncons(spine);
                        if ($2217 instanceof Data_Maybe.Just && $2217.value0.head instanceof ExternApp) {
                            if (v1.value1 instanceof ExternExpr) {
                                var ref = new EvalExtern(qual);
                    ...
                    var $2228 = Data_Array.uncons(spine);
                    if ($2228 instanceof Data_Maybe.Just && $2228.value0.head instanceof ExternApp) {
                        var $2229 = Data_Array.uncons($2228.value0.tail);
                        if ($2229 instanceof Data_Maybe.Just && ($2229.value0.head instanceof ExternAccessor && $2229.value0.head.value0 instanceof PureScript_Backend_Optimizer_Syntax.GetProp)) {
                            if (v1.value1 instanceof ExternExpr) {
                                var ref = new EvalExtern(qual);
                                var v5 = bind(lookup3(ref)(v.directives))(lookup2(new InlineSpineProp($2229.value0.head.value0.value0)));
                                if (v5 instanceof Data_Maybe.Just && v5.value0 instanceof InlineAlways) {
                                    return new Data_Maybe.Just(evalSpine(v)(eval2(envForGroup(v)(ref)(new InlineSpineProp($2229.value0.head.value0.value0))(v1.value1.value0))(v1.value1.value1))(spine));
                                };
                                return Data_Maybe.Nothing.value;
                            };
                            return Data_Maybe.Nothing.value;
                ...
                var $2245 = Data_Array.uncons(spine);
                if ($2245 instanceof Data_Maybe.Just && ($2245.value0.head instanceof ExternAccessor && $2245.value0.head.value0 instanceof PureScript_Backend_Optimizer_Syntax.GetProp)) {
                    if (v1.value1 instanceof ExternExpr) {
                        var ref = new EvalExtern(qual);
                        var v3 = bind(lookup3(ref)(v.directives))(lookup2(new InlineProp($2245.value0.head.value0.value0)));
                        if (v3 instanceof Data_Maybe.Just && v3.value0 instanceof InlineAlways) {
                            return new Data_Maybe.Just(evalSpine(v)(eval2(envForGroup(v)(ref)(new InlineProp($2245.value0.head.value0.value0))(v1.value1.value0))(v1.value1.value1))(spine));
                        };
                        return Data_Maybe.Nothing.value;
                    };
                    var v3 = function (v4) {
                    ...
                    if (v1.value1 instanceof ExternDict) {
                        var $2252 = PureScript_Backend_Optimizer_CoreFn.findProp($2245.value0.head.value0.value0)(v1.value1.value1);
                        if ($2252 instanceof Data_Maybe.Just) {
                            var ref = new EvalExtern(qual);
                            var v4 = bind(lookup3(ref)(v.directives))(lookup2(new InlineProp($2245.value0.head.value0.value0)));
                            if (v4 instanceof Data_Maybe.Just && v4.value0 instanceof InlineAlways) {
                                return new Data_Maybe.Just(evalSpine(v)(eval2(envForGroup(v)(ref)(new InlineProp($2245.value0.head.value0.value0))(v1.value1.value0))($2252.value0.value1))($2245.value0.tail));
                            };
                            return Data_Maybe.Nothing.value;
                        };
                        return v3(true);
