...
var ordTuple = /* #__PURE__ */ Data_Tuple.ordTuple(/* #__PURE__ */ Data_Ord.ordArray(Test_Spec_Tree.ordPathItem))(Data_Ord.ordString);
var insert = /* #__PURE__ */ Data_Map_Internal.insert(ordTuple);
var update = /* #__PURE__ */ Data_Map_Internal.update(ordTuple);
...
var RunningTest = /* #__PURE__ */ (function () {
    function RunningTest(value0) {
        this.value0 = value0;
    };
    RunningTest.create = function (value0) {
        return new RunningTest(value0);
    };
    return RunningTest;
})();
var RunningPending = /* #__PURE__ */ (function () {
    ...
    RunningPending.value = new RunningPending();
    return RunningPending;
})();
var RunningSuite = /* #__PURE__ */ (function () {
    function RunningSuite(value0) {
        this.value0 = value0;
    };
    RunningSuite.create = function (value0) {
        return new RunningSuite(value0);
    };
    return RunningSuite;
})();
var genericRunningItem_ = {
    to: function (x) {
        if (x instanceof Data_Generic_Rep.Inl) {
            return new RunningTest(x.value0);
        };
        if (x instanceof Data_Generic_Rep.Inr && x.value0 instanceof Data_Generic_Rep.Inl) {
            return RunningPending.value;
        };
        if (x instanceof Data_Generic_Rep.Inr && x.value0 instanceof Data_Generic_Rep.Inr) {
            return new RunningSuite(x.value0.value0);
        };
        throw new Error("Failed pattern match at Test.Spec.Reporter.Base (line 106, column 1 - line 106, column 38): " + [ x.constructor.name ]);
    },
    from: function (x) {
...
var showRunningItem = {
    show: /* #__PURE__ */ Data_Show_Generic.genericShow(genericRunningItem_)(/* #__PURE__ */ Data_Show_Generic.genericShowSum(/* #__PURE__ */ Data_Show_Generic.genericShowConstructor(/* #__PURE__ */ Data_Show_Generic.genericShowArgsArgument(/* #__PURE__ */ Data_Maybe.showMaybe(Test_Spec_Result.showResult)))({
    ...
    }))(/* #__PURE__ */ Data_Show_Generic.genericShowConstructor(/* #__PURE__ */ Data_Show_Generic.genericShowArgsArgument(Data_Show.showBoolean))({
        reflectSymbol: function () {
            return "RunningSuite";
        }
    }))))
...
var printFailures = function (dictMonadWriter) {
    ...
    return function (xs$prime) {
            ...
            return traverse_(function (v) {
                ...
                if (v instanceof Test_Spec_Tree.Leaf && (v.value1 instanceof Data_Maybe.Just && v.value1.value0 instanceof Test_Spec_Result.Failure)) {
                    return bind1(modify(add(1)))(function (i) {
                        var label = intercalate(" ")(append(Test_Spec_Tree.parentSuiteName(v.value0.value0))([ v.value0.value1 ]));
        ...
        var go = $lazy_go(62);
        return evalStateT(go(Test_Spec_Tree.annotatedWithPaths(xs$prime)))(0);
    };
};
    ...
    return function (e) {
        var modifyRunningItems = function (f) {
            var runningItemIsFinished = function (v) {
                ...
                if (v instanceof RunningTest) {
                    return Data_Maybe.isJust(v.value0);
                };
                if (v instanceof RunningSuite) {
                    return v.value0;
                };
                throw new Error("Failed pattern match at Test.Spec.Reporter.Base (line 161, column 33 - line 164, column 44): " + [ v.constructor.name ]);
            };
        ...
        var baseUpdate = function (v) {
            ...
            if (v instanceof Test_Spec_Runner_Event.Suite && v.value0 instanceof Test_Spec_Runner_Event.Parallel) {
                return modifyRunningItems(insert(v.value1)(new RunningSuite(false)));
            };
            if (v instanceof Test_Spec_Runner_Event.SuiteEnd) {
                return modifyRunningItems(Data_Function.flip(update)(v.value0)(function (v1) {
                    if (v1 instanceof RunningSuite) {
                        return new Data_Maybe.Just(new RunningSuite(true));
                    };
            ...
            if (v instanceof Test_Spec_Runner_Event.Test && v.value0 instanceof Test_Spec_Runner_Event.Parallel) {
                return modifyRunningItems(insert(v.value1)(new RunningTest(Data_Maybe.Nothing.value)));
            };
            if (v instanceof Test_Spec_Runner_Event.TestEnd) {
                return bind(gets(opts.getRunningItems))(function (runningItems) {
                    var v1 = lookup(v.value0)(runningItems);
                    if (v1 instanceof Data_Maybe.Just && v1.value0 instanceof RunningTest) {
                        return modifyRunningItems(insert(v.value0)(new RunningTest(new Data_Maybe.Just(v.value1))));
                    };
                    if (v1 instanceof Data_Maybe.Nothing) {
                        return opts.printFinishedItem(v.value0)(new RunningTest(new Data_Maybe.Just(v.value1)));
                    };
                    return pure(Data_Unit.unit);
                });
            };
            if (v instanceof Test_Spec_Runner_Event.Pending) {
                return bind(gets(opts.getRunningItems))(function (runningItems) {
                    return unless(Data_Map_Internal.isEmpty(runningItems))(modifyRunningItems(insert(v.value0)(RunningPending.value)));
                });
            };
            ...
            throw new Error("Failed pattern match at Test.Spec.Reporter.Base (line 122, column 18 - line 149, column 33): " + [ v.constructor.name ]);
        };
